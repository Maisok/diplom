        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach($favorites as $equipment)
                <div class="bg-[#3C3C3C] hover:bg-gray-800 rounded-xl border border-gray-700 overflow-hidden transition-all">
                    ...
                    <div class="px-4 pb-4">
                        <a href="{{ route('cars.show', $equipment) }}" class="w-full inline-flex justify-center items-center px-3 py-2 text-sm font-medium text-center text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition">
                            Подробнее
                        </a>
                    </div>
                </div>
