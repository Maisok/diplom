            ...
            <div class="p-6">
                <div class="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <p><strong class="text-gray-400">Статус:</strong>
                                <span class="inline-block px-2 py-1 text-xs font-semibold rounded-full
                                    @switch($booking->status)
                                        ...
                                        @case('cancelled') bg-gray-500/20 text-gray-400 @break
                            ...
                            <p><strong class="text-gray-400">Дата визита:</strong> <span class="text-white">{{ $booking->appointment_date->format('d.m.Y H:i') }}</span></p>
                ...
                <div class="bg-[#2D2D2D] p-4 rounded-lg">
                    ...
                    <div class="space-y-1">
                        ...
                        <p><strong class="text-gray-400">Телефон:</strong> <span class="text-white">{{ $booking->car->branch->phone }}</span></p>
                        <p><strong class="text-gray-400">Email:</strong> <span class="text-white">{{ $booking->car->branch->email }}</span></p>
                    </div>
                </div>
