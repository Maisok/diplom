            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-[#2A2A2A]  rounded-2xl shadow-xl p-6 border border-gray-700">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <span class="bg-gray-700 text-gray-300 text-xs font-medium px-2.5 py-0.5 rounded-full">{{ $user->favoriteEquipments->count() }}</span>
                    </div>
                        ...
                        @else
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                @foreach($user->favoriteEquipments->take(10) as $equipment)
                                    <div class="bg-[#3C3C3C] hover:bg-gray-800 rounded-xl border border-gray-700 overflow-hidden transition-all">
                                        ...
                                        <div class="px-4 pb-4">
                                            <a href="{{ route('cars.show', $equipment) }}" class="w-full inline-flex justify-center items-center px-3 py-2 text-sm font-medium text-center text-[#ffffff] bg-indigo-600 rounded-lg hover:bg-indigo-700 transition">
                                                Подробнее
                                            </a>
                                        </div>
                                    </div>
                            ...
                            @if($user->favoriteEquipments->count() > 10)
                                <div class="mt-6 text-center">
                                    <a href="{{ route('favorites.all') }}" class="text-indigo-400 hover:text-indigo-300 text-sm font-medium">
