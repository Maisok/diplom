            ...
            <form action="{{ route('brands.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
              ...
              <div class="space-y-3">
                <div>
                  ...
                  <input type="text" name="name" id="brand-name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required maxlength="50">
                </div>
                <div>
            ...
            <form action="{{ route('models.store') }}" method="POST" class="space-y-4">
              ...
              <div class="space-y-3">
                <div>
                  ...
                  <select name="brand_id" id="model-brand_id" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                ...
                <div>
                  ...
                  <input type="text" name="name" id="model-name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required maxlength="50">
                </div>
              </div>
              <div class="pt-2">
                <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            ...
            <form action="{{ route('generations.store') }}" method="POST" class="space-y-4">
              ...
              <div class="space-y-3">
                <div>
                  ...
                  <select name="car_model_id" id="generation-model_id" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                ...
                <div>
                  ...
                  <input type="text" name="name" id="generation-name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required maxlength="50">
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label for="year_from" class="block text-sm font-medium text-gray-700 mb-1">Год начала выпуска</label>
                    <input type="number" name="year_from" id="year_from" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required min="1900" :max="date('Y') + 10">
                  </div>
                  <div>
                    <label for="year_to" class="block text-sm font-medium text-gray-700 mb-1">Год окончания выпуска</label>
                    <input type="number" name="year_to" id="year_to" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" min="1900" :max="date('Y') + 10">
                  </div>
                </div>
              </div>
              <div class="pt-2">
          ...
          <form id="search-form" method="GET" action="#" class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select id="brand-select" name="brand_id" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
                  <option value="">Выберите марку</option>
              ...
              <div>
                ...
                <select id="model-select" name="model_id" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" disabled>
                  <option value="">Выберите модель</option>
                </select>
              </div>
              <!-- Generation -->
              <div>
                ...
                <select id="generation-select" name="generation_id" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" disabled>
        ...
        fetch(`/api/models?${new URLSearchParams(params)}`)
            ...
            .then(data => {
                if (page === 1 && highlight_id) {
                    // Удаляем старые данные, кроме выделенной модели
                    Array.from(container.children).forEach(child => {
                        if (!child.classList.contains('highlighted')) {
                            child.remove();
                        }
