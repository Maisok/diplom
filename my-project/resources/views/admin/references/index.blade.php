        ...
        <div class="space-y-4">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div id="bodyTypesContent" class="hidden px-4 py-5 sm:p-6">
                    ...
                    <!-- Pagination -->
                    <div class="mt-4">
                        {{ $bodyTypes->appends(['search' => request('search')])->links() }}
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div id="driveTypesContent" class="hidden px-4 py-5 sm:p-6">
                    ...
                    <!-- Pagination -->
                    <div class="mt-4">
                        {{ $driveTypes->appends(['search' => request('search')])->links() }}
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div id="engineTypesContent" class="hidden px-4 py-5 sm:p-6">
                    ...
                    <!-- Pagination -->
                    <div class="mt-4">
                        {{ $engineTypes->appends(['search' => request('search')])->links() }}
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div id="transmissionTypesContent" class="hidden px-4 py-5 sm:p-6">
                    ...
                    <!-- Pagination -->
                    <div class="mt-4">
                        {{ $transmissionTypes->appends(['search' => request('search')])->links() }}
                    </div>
                </div>
            </div>
