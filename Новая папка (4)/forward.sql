...
--
-- Хост: MySQL-8.0
-- Время создания: Май 27 2025 г., 02:35
...
(2, 2, 'WVGZZZCAZJC222222', 13250, 8250000.00, 'Как эксплуатировался\r\n• Подтвержденный пробег 19 456км\r\n• Заводской окрас\r\n• Без аварий\r\n• Только летняя эксплуатация\r\n\r\nКак обслуживали\r\n• Авто в состоянии нового\r\n• Вce планoвыe ТO провели у дилера с применением качественных расходников\r\n• Пpoизвeдeнa пpедпродажнaя подгoтовка: химчиcткa/пoлиpовкa/замена жидкоcтeй\r\n\r\nЧто с документами\r\n• Владельцы – физические лица\r\n• ПТС электронный\r\n• Сервисная книжка в наличии\r\n• Транспортное средство без обременений и ограничений на регистрационные действия\r\n• Возможна любая форма продажи и оплаты\r\n\r\nЧем подтвердим\r\n• Организуем бесплатный подъемник\r\n• Предоставим лист диагностики систем автомобиля\r\n• Покажем отчет по истории его эксплуатации', 0, 2, 4, NULL, NULL, '2025-05-26 10:07:54', '2025-05-26 10:08:52'),
...
CREATE TABLE `equipment` (
  ...
  `fuel_tank_volume` int DEFAULT NULL,
...
('0qipCeiMpc1KYn6HsHhE4DuWWijbFNNJoiiV4Au0', 3, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/136.0.0.0 Safari/537.36', '', 1748284507),
('1hFaUcQXIFMRk0gicg8doSz7cs6WVHbjytAO6kBX', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/136.0.0.0 Safari/537.36', '', 1748280684);
...
(1, 'Кирилл', 'miasnikov2005@gmail.com', '8 111 111 11 11', '$2y$12$6hYvLmh/XP2AY6zZNyj13uVgYosaFSBB8FCYpwagwxflCRnhXbLB2', 'user', NULL, NULL, '2025-05-26 09:29:57', '2025-05-26 09:29:57'),
